(function ($) {
	...
	$.fn.mauGallery.defaults = {
		columns: 3, lightBox: true, lightboxId: null, showTags: true, tagsPosition: "bottom", navigation: true
	};
	...
	$.fn.mauGallery.methods = {
		createRowWrapper(element) {
			...
			var tagItems = '<li class="nav-item"><span class="nav-link filter-item active active-tag" data-images-toggle="all">Tous</span></li>';
			$.each(tags, function (index, value) {
				tagItems += `<li class="nav-item active">
                <span class="nav-link filter-item" data-images-toggle="${value}">${value}</span></li>`;
			});
			...
			// Retirer la classe 'active-tag' de l'élément actuellement actif
			$(".active-tag").removeClass("active-tag").css("background-color", "#fff");

			// Ajouter la classe 'active-tag' à l'élément cliqué
			...
			$(".gallery-item").each(function () {
				...
				if (tag === "all") {
					parentColumn.show(300); // Afficher tous les éléments
